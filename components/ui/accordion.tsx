...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between border-b py-2 text-sm font-medium transition-all hover:text-secondary-foreground [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
